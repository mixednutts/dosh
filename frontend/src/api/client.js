...
export const getHealthScales = id => api.get(`/budgets/${id}/health-matrix/scales`).then(r => r.data)
...
export const deleteHealthMatrixTemplate = (id, templateKey) => api.delete(`/budgets/${id}/health-matrix/templates/${encodeURIComponent(templateKey)}`).then(r => r.data)
...
export const removeMatrixItem = (id, metricId) => api.delete(`/budgets/${id}/health-matrix/items/${metricId}`).then(r => r.data)
export const deleteBudgetHealthMatrix = id => api.delete(`/budgets/${id}/health-matrix/`).then(r => r.data)
export const createEmptyHealthMatrix = id => api.post(`/budgets/${id}/health-matrix/create-empty`).then(r => r.data)
export const saveHealthMatrixTemplate = (id, data) => api.post(`/budgets/${id}/health-matrix/save-template`, data).then(r => r.data)
