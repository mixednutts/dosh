...
describe('Layout navigation', () => {
  ...
  it('shows the canonical release version in the sidebar chrome', async () => {
    ...
    expect(await screen.findByText('v0.6.11-alpha')).toBeTruthy()
  ...
  it('opens release notes from the version label', async () => {
    ...
    fireEvent.click(await screen.findByRole('button', { name: /v0.6.11-alpha/i }))
