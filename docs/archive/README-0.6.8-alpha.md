...
**Archived:** This document is the original development-focused README preserved from version 0.6.8-alpha. It has been superseded by the new user-facing README.md.
